...
const Chatbox = ({ publicationContent = '' }) => {
  ...
  const resetChat = () => {
    setMessages([{ role: role.assistant, content: initialMessage }]);
    setMessageInput('');
  };
          ...
          >
            <div className="flex items-center justify-between w-full p-2">
              ...
              <div className="flex gap-1">
                ...
                <button
                  onClick={resetChat}
                  className={`p-1 rounded-full bg-orange-400 text-white w-10 h-10 flex items-center justify-center shadow-md hover:opacity-75`}
                >
          ...
          >
            <div className="bg-white p-4 rounded-lg shadow-md ">
              <div className="mb-2 flex flex-col gap-2 overflow-y-scroll scroll-smooth h-96 py-2">
                ...
                >
                  <p>Pídele a la IA lo que necesites 🤗</p>
